...
The dataset 'plantspec.data' includes all of the wet lab data for this example. We will start by subsetting those data until have have only the data we want to use for model fitting. For example, we only want data from the original dataset and excluding Bryophytes and litter samples.
